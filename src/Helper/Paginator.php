...
class Paginator
{
     ...
     * @param int $midRange
     */
    function __construct($itemsCount, $currentPage = 1, $limit = 10, $midRange = 3)
    {
    ...
    {
        $radius = floor($this->midRange / 2);
        $startRange = $this->currentPage - $radius;
        $endRange = $this->currentPage + $radius;
